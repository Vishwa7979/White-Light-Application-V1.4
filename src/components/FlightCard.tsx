...
function Frame11() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full px-2">
      <Frame2 />
      <Frame10 />
      <Frame3 />
    </div>
...
function Frame9() {
  return (
    <div className="bg-[#27272a] content-stretch flex gap-[24px] h-[53px] items-center px-[23px] py-[9px] relative rounded-[16px] shrink-0 w-full">
...
export default function FlightCard({ onSelect }: { onSelect?: () => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center relative w-full max-w-[353px]" data-name="Default">
