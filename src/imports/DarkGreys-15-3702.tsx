import svgPaths from "./svg-pjfzviklda";
...
function Bg() {
  return (
    <div className="absolute h-[905px] left-0 overflow-clip top-0 w-[393px]" data-name="bg">
      <div className="absolute bg-[#121212] h-[905px] left-0 top-0 w-[393px]" />
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[20px] top-[144px] w-[353px]">
