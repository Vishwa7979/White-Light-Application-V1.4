import svgPaths from "./svg-66wq6p6jwz";
...
function AvatarChatScreenEffects() {
  return (
    <div className="absolute h-[852px] left-0 overflow-clip top-0 w-[393px]" data-name="Avatar Chat - Screen Effects">
      <div className="absolute bg-[rgba(0,0,0,0.04)] h-[852px] left-0 top-0 w-[393px]">
        <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_0px_10px_4px_rgba(255,255,255,0.2),inset_0px_0px_30px_4px_rgba(15,158,225,0.4),inset_0px_0px_60px_4px_rgba(43,186,247,0.4)]" />
      </div>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute bottom-[208px] content-stretch flex flex-col gap-[20px] items-start left-[20px] w-[353px]">
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#fcfcfc] text-[18px] text-right tracking-[0.36px] w-[min-content]">
        <p className="leading-[1.2]">How do I start my |</p>
      </div>
    </div>
  );
}
...
function AiVoiceVoice() {
  return (
    <div className="backdrop-blur-[27.632px] backdrop-filter content-stretch flex items-center justify-center p-[12px] relative rounded-[30px] shrink-0 size-[50px]" data-name="AI - Voice-Voice" style={{ backgroundImage: "linear-gradient(225deg, rgb(101, 111, 251) 9.5%, rgba(0, 0, 0, 0) 72.5%), linear-gradient(117.35deg, rgba(0, 0, 0, 0) 12.523%, rgba(5, 238, 250, 0.4) 85.205%), url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 50 50\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'0.20000000298023224\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(-3.625 2.75 -5.3708 -7.0797 25 25)\\'><stop stop-color=\\'rgba(38,38,38,1)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(19,19,19,0.5)\\' offset=\\'0.5\\'/><stop stop-color=\\'rgba(0,0,0,0)\\' offset=\\'1\\'/></radialGradient></defs></svg>')" }}>
      <div aria-hidden="true" className="absolute border-[#1d1d1d] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[30px]" />
      <SolarStopBold />
    </div>
  );
}
...
function BiCcCircle() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="bi:cc-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_9_3744)" id="bi:cc-circle">
          <path d={svgPaths.p3a4eea00} fill="var(--fill-0, #1D1D20)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_9_3744">
...
function CaptionLanguageInputButton() {
  return (
    <div className="bg-[#fcfcfc] content-stretch flex items-center justify-center p-[10px] relative rounded-[32px] shrink-0 size-[38px]" data-name="Caption/Language Input Button">
      <BiCcCircle />
    </div>
  );
}
...
function AvatarChatInputDock() {
  return (
    <div className="absolute backdrop-blur-[20px] backdrop-filter bottom-0 content-stretch flex flex-col gap-[10px] items-center left-0 pb-[30px] pt-[20px] px-[20px] rounded-tl-[32px] rounded-tr-[32px] w-[393px]" data-name="Avatar Chat - Input Dock" style={{ backgroundImage: "linear-gradient(254.473deg, rgba(29, 29, 29, 0.6) 0.61931%, rgba(0, 0, 0, 0.2) 100%)" }}>
...
function Component1() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Component 4">
      <Component />
      <p className="-webkit-box font-['Urbanist:Medium',sans-serif] font-medium leading-[1.2] overflow-ellipsis overflow-hidden relative shrink-0 text-[#d0d0d4] text-[14px] text-nowrap tracking-[0.28px]">On</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#b774fc] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">English</p>
      </div>
      <Tick />
    </div>
  );
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] h-[403px] items-start overflow-clip relative shrink-0 w-full">
      <Frame2 />
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Hindi</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Telugu</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Hinglish</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Abkhaz</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Aborlan</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Abron</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Acehnese</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Acholi</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Achomi</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Adamawa Fulfulde</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Adyghe</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Afar</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Afrikaans (Suid-Afrika)</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Ahirani</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Ajagbe</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Akan</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Akoose</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Alas</p>
      </div>
      <div className="flex flex-col font-['Urbanist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#a1a1aa] text-[16px] text-nowrap tracking-[0.64px]">
        <p className="leading-[1.2]">Alphabet</p>
      </div>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="backdrop-blur-[10px] backdrop-filter bg-[rgba(255,255,255,0.9)] h-[48px] relative rounded-[32px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[18px] py-[10px] relative size-full">
          <p className="font-['Urbanist:Medium',sans-serif] font-medium leading-[1.2] relative shrink-0 text-[#1d1d20] text-[16px] text-nowrap tracking-[0.32px]">Select</p>
        </div>
      </div>
    </div>
  );
...
function AiResponse() {
  return (
    <div className="backdrop-blur-[20px] backdrop-filter bg-[rgba(39,39,42,0.8)] relative rounded-[24px] shrink-0 w-full" data-name="AI Response">
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-center left-[20px] top-[133px] w-[353px]">
      <AiResponse />
      <Planner1 />
    </div>
  );
...
export default function DarkGreys() {
  return (
    <div className="bg-black relative size-full" data-name="Dark - Greys">
      <PageHeadersDark />
      <HomeIndicator />
      <div className="absolute backdrop-blur-[10px] backdrop-filter bg-[rgba(29,29,32,0.8)] h-[852px] left-0 top-0 w-[393px]" />
      <Frame12 />
      <AvatarFrameDefault1 />
      <AvatarChatScreenEffects />
      <Frame6 />
      <AvatarChatInputDock />
    </div>
  );
