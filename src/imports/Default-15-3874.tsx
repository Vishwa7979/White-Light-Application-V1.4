import svgPaths from "./svg-zging7hphj";
import imgImage685 from "figma:asset/fbaa074acad8c2827683302428dfd40460af05fc.png";

function Frame4() {
  return (
    <div className="absolute content-stretch flex font-['Urbanist:Medium',sans-serif] font-medium items-center justify-between leading-[1.2] left-[14px] px-[10px] py-0 text-[#f4f4f5] text-[10px] text-nowrap top-[14px] tracking-[0.2px] w-[325px]">
...
function Group() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <div className="absolute backdrop-blur-[27px] backdrop-filter border border-[rgba(123,123,123,0.2)] border-solid h-[280px] left-0 rounded-[26px] top-0 w-[353px]" data-name="image 686" style={{ backgroundImage: "linear-gradient(rgba(11, 10, 10, 0.42) 0%, rgba(0, 0, 0, 0) 21.078%, rgba(0, 0, 0, 0) 40.1%, rgba(0, 0, 0, 0.42) 53.084%, rgba(11, 10, 10, 0.7) 100%)" }} />
      <Frame4 />
      <Frame8 />
    </div>
  );
